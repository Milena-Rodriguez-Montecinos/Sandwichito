...
describe("Negative tests of Items feature from Todo.ly website", () => {
    ...
    `(
        "Verify that I get an error status code as a response body when a PUT request to the 'items/[id].json' is sent with $statusTitle value in 'ProjectID' variable",
